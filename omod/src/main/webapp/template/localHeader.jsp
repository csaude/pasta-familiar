...
<ul id="menu">
	...
	<li
		...
		<li
		<c:if test='<%= request.getRequestURI().contains("/searchFamilyList") %>'>class="active"</c:if>>
		<a
		href="${pageContext.request.contextPath}/module/gaac/searchFamilyList.form"><spring:message
				code="gaac.fmsearch" /></a>
	</li>
